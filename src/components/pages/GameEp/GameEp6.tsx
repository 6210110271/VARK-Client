...
function GameEp6() {
  const [items, setItems] = useState<Item[]>([
    ...
    { id: 1, img: `${process.env.PUBLIC_URL}/images/photo-front-3.5.PNG`, stat: '', clicked: false },
    { id: 2, img: `${process.env.PUBLIC_URL}/images/photo-front-3.7.PNG`, stat: '', clicked: false },
    { id: 2, img: `${process.env.PUBLIC_URL}/images/photo-front-3.8.PNG`, stat: '', clicked: false },
